...
def verify_titans():
    ...
    print(f"Titans Suggests Neighbor with Sum={np.sum(best_rule)}, Predicted Entropy={pred_ent:.4f}")
    ...
    print(f"From Sum=10, Titans Suggests Neighbor (Sum={np.sum(best_rule)}), Pred={pred_ent:.4f}")
